...
<div class="w-140 flex flex-col pb-4 pt-2 bg-[#2F2B2E] rounded-lg shadow-lg gap-4 post-container">
    ...
    <div class="px-4 flex flex-col">
        <div class="flex justify-between">
            ...
            @if ($userId == $postUserId)
                <svg class="deletePost cursor-pointer hover:scale-110 transition-all" data-post-id="{{ $postId }}"
    ...
    <div class="flex justify-between items-center px-28 w-full">
        <div class="flex gap-2 items-center">
            <svg data-user-id="{{ $postUserId }}" data-post-id="{{ $postId }}"
                class="cursor-pointer like hover:scale-110 transition-all" xmlns="http://www.w3.org/2000/svg" width="31"
        ...
        <div class="flex gap-2 items-center">
            <svg class="cursor-pointer comment hover:scale-110 transition-transform" xmlns="http://www.w3.org/2000/svg" width="31" height="30"
            ...
            <p class="text-white text-base likeCount">{{ $comments }}</p>
        </div>
