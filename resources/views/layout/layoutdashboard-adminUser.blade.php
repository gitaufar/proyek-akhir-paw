...
<head>
    <meta charset="UTF-8">
    <title>@yield('Dashboard Admin')</title>
...
<body class="min-w-screen min-h-screen bg-black flex flex-col overflow-x-hidden">
    <nav class="fixed w-screen top-0 flex justify-end items-center bg-[#2F2B2E] py-5 px-10 shadow-lg z-100">
        {{-- Kontainer Profile--}}
    ...
    <div class="absolute w-1/4 h-screen bg-[#2F2B2E] flex">
        <div class="mt-40 w-full flex flex-col items-center gap-10">
            ...
            <div class="w-3/4 h-15 flex flex-row bg-amber-300 rounded-xl items">
                <div class="w-15 h-15">
                    <svg class="w-25 h-25" xmlns="http://www.w3.org/2000/svg" fill="black" viewBox="0 0 40 40">
    ...
    <div class="ml-[25%] w-3/4 flex flex-col  items-center justify-start h-screen">
        {{-- Profile Card--}}
        <div class="top-0 w-3/5 h-132 absolute bg-amber-300 mt-65 flex flex-row justify-start gap-10 items-start rounded-2xl">
            {{-- Image--}}
            <div class="mt-10 w-1/4 h-110 bg-amber-100 ml-10 items-center justify-center flex">
                image.jpg
            </div>
            {{--Container--}}
            <div class="w-160 h-120 mt-10 flex flex-col gap-2 items-start">
                {{-- Name--}}
                <div class="font-['Poppins'] w-full h-20 flex items-center">
                    <p class=" text-black text-5xl font-medium">Aji Saka Kartosuro W.</p>
                </div>
                {{-- Email--}}
                <div class="w-full h-10 flex items-center">
                    <p class=" text-black text-xl font-normal">ajikara609@ub.ac.id</p>
                </div>
                {{-- Role--}}
                <div class="w-full h-10 flex items-center">
                    <p class=" text-black text-xl font-normal">Admin</p>
                </div>
                {{-- Modul diselesaikan--}}
                <div class="w-full h-screen flex items-center">
                    <p class="mt-65 text-black text-xl font-normal">Modul diselesaikan: -</p>
                </div>
                <div class="w-full h-10 flex justify-end items-end gap-1">
                    <div class="w-7 h-full  flex items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                            <path d="M7.127 22.562l-7.127 1.438 1.438-7.128 5.689 5.69zm1.414-1.414l11.228-11.225-5.69-5.692-11.227 11.227 5.689 5.69zm9.768-21.148l-2.816 2.817 5.691 5.691 2.816-2.819-5.691-5.689z" />
                        </svg>
                    </div>
                    <p class="mr-4 text-black text-xl font-light">Edit</p>
                </div>
            </div>
        </div>
    </div>
