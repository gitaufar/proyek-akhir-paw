                    ...
                    <a href="{{ route('community') }}" class="block">
                        <div class="px-2 py-2 rounded-xl group group-hover:bg-amber-300 transition-all">
                            <svg xmlns="http://www.w3.org/2000/svg" width="34" height="30" viewBox="0 0 34 30" fill="none">
                                <path class="transition-all svg-path-fill group-hover:fill-black" fill-rule="evenodd"
                                    clip-rule="evenodd"
                                    ...
                                    fill="white" />
                                <path class="svg-path-fill group-hover:fill-black transition-all" fill-rule="evenodd"
                                    clip-rule="evenodd"
